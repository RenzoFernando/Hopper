...
export function RoomAccess(props: Props) {
  ...
  return <aside className="room-access-panel" aria-label="Salas de Hopper">
    <div className="room-access-heading"><span>Salas disponibles</span><strong id="room-capacity">{props.available === null ? "—" : props.available} / {props.maximum === null ? "—" : props.maximum}</strong></div>
